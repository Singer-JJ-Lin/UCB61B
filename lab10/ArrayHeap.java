...
public class ArrayHeap<T> implements ExtrinsicPQ<T> {
    ...
    private void swim(int index) {
        ...
        while (inBounds(parentIndex) && contents[index].myPriority < contents[parentIndex].myPriority) {
    ...
    private void sink(int index) {
        ...
        while (inBounds(minChildIndex) && contents[index].myPriority > contents[minChildIndex].myPriority) {
